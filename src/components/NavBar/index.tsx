...
export const NavBar: React.FC<NavBarProps> = ({ isAdmin }) => {
    ...
    return (
        <nav className="flex justify-between items-center pl-4 bg-primary_300 w-full h-10 pr-4">
            <ul className="flex text-gray_100 h-full items-center justify-center gap-3">
